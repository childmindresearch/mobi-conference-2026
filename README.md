# 🧠 MoBI Laboratory — Resources, Tools & Publications Hub

[![Open Science](https://img.shields.io/badge/Open%20Science-MoBI%20Lab-blue.svg)](https://github.com/)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](https://opensource.org/licenses/MIT)
[![LSL Supported](https://img.shields.io/badge/Lab%20Streaming%20Layer-Supported-brightgreen.svg)](https://github.com/sccn/labstreaminglayer)

Welcome to the **Child Mind Institute's MoBI (Multimodal Brain/Body Imaging) Laboratory Resource Hub**. This repository serves as a centralized index of open-source tools, abstracts, and posters developed by our team for the 6th International Mobile Brain/Body Imaging Conference.
...
### 2. **MoBI-View: Realtime Biosignal Visualization**
...
### 3. **Multimodal Brain-Body Automated QC Framework**
- **Repository**: [github.com/childmindresearch/MOBI_QC](https://github.com/childmindresearch/MOBI_QC)
- **Description**: A scalable software framework that automates data quality assurance from live data acquisition to post-session reporting in multimodal setups.
- **Files**: [Abstract (PDF)](./abstracts/acquisition_to_assurance_qc_abstract.pdf) | [Poster (PDF)](./posters/acquisition_to_assurance_qc_poster.pdf)

---

### 4. **Realtime Motion Capture QC Mechanism**
- **Repository**: [github.com/childmindresearch/zed2i_motion_classifier](https://github.com/childmindresearch/zed2i_motion_classifier)
- **Description**: Dedicated automated quality control mechanism that processes optical and sensor-based MoCap data in real-time to detect marker loss, tracking artifacts, and subject movement boundaries.
- **Files**: [Abstract (PDF)](./abstracts/realtime_mocap_qc_abstract.pdf) | [Poster (PDF)](./posters/realtime_mocap_qc_poster.pdf)

---

### 5. **CAMI Study Replication Toolkit (Pediatric Neurodivergent Population)**
- **Description**: Software tools and data analysis pipeline for replicating the Computerised Assessment of Motion Imitation (CAMI) protocol tailored for neurodivergent pediatric cohorts.
- **Files**: [Abstract (PDF)](./abstracts/cami_study_replication_abstract.pdf) | [Poster (PDF)](./posters/cami_study_replication_poster.pdf)

---

### 6. **CMI's Graphomotor Protocol**
- **Repository**: [github.com/childmindresearch/graphomotor_cmi](https://github.com/childmindresearch/graphomotor_cmi)
- **Description**: Graphomotor protocol that CMI implemented in their MoBI laboratories.

---

### 7. **MoBI Scene Camera**
- **Repository**: [github.com/childmindresearch/MoBI-Neon-GUI](https://github.com/childmindresearch/MoBI-Neon-GUI)
- **Description**: A simple, clean GUI application for recording video from Pupil Labs Neon devices with synchronized LSL markers.

---

### 8. **MoBI Markers**
- **Repository**: [github.com/childmindresearch/MoBI-Markers](https://github.com/childmindresearch/MoBI-Markers)
- **Description**: A Python GUI application for sending LSL (Lab Streaming Layer) markers used in neuroscience research.

---

### 9. **MoBI Audio & Video**
- **Repository**: [github.com/childmindresearch/MoBI-AV](https://github.com/childmindresearch/MoBI-AV)
- **Description**: A simple application for recording audio and video simultaneously with device selection and synchronization capabilities.
